...
const SERVERS = ["VidLink", "VidSrc.to", "My Server", "YouTube Trailer"];
...
export default function Watch() {
  ...
  const renderPlayer = () => {
    ...
    if (activeServer === 1)
      return <iframe key={"vt"+id} src={`https://vidsrc.to/embed/movie/${id}`} style={styles.iframe} allowFullScreen allow={ALLOW} />;
    if (activeServer === 2) {
