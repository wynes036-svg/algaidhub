...
const styles = {
  ...
  seasonSelect: { background: "#1a1a1a", color: "#fff", border: "1px solid #333", borderRadius: "6px", padding: "8px 16px", fontSize: "14px", cursor: "pointer" },
  ...
  epInfo: { flex: 1 },
  epTitle: { fontSize: "15px", fontWeight: "500", color: "#fff", marginBottom: "4px" },
  epMeta: { fontSize: "12px", color: "#888", marginBottom: "6px" },
